...
export const LEVELS: LevelMeta[] = [
  ...
  },
  {
    ...
    label: "Elementary",
    description:
      "You can understand frequently used expressions and common topics.",
    scoreRange: [4, 5],
  },
  {
    id: "B1",
    label: "Intermediate",
    description:
      "You can deal with most situations and describe experiences clearly.",
    scoreRange: [6, 7],
  },
  {
    id: "B2",
    ...
    description:
      "You can understand complex texts and express yourself fluently.",
    scoreRange: [8, 8],
  },
  {
    id: "C1",
