  ...
  return (
    <Animated.View style={containerStyle}>
      <Pressable onPress={onToggle} accessibilityLabel={field.label}>
        <View style={[styles.card, selected && { borderColor: field.color, borderWidth: 2 }]}>
          {/* Color accent strip */}
          ...
          <View style={styles.cardContent}>
            <View style={styles.cardLeft}>
              ...
              >
                <Ionicons name={field.icon.name as any} size={22} color="#fff" />
              </LinearGradient>
            ...
            <View style={[
              styles.checkCircle,
              selected && { backgroundColor: field.color, borderColor: field.color },
            ]}>
